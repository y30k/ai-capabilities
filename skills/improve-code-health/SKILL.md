...
description: |
  Improve code health through architecture review, complexity reduction, safe refactoring, dependency cleanup, and behavior-preserving validation. Use when the user asks for an architecture sweep, codebase health review, simplification, refactor safely, reduce complexity, or improve maintainability.
---
